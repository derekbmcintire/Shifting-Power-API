...
ActiveRecord::Schema.define(version: 20180114191652) do
  ...
  create_table "userratings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_userratings_on_user_id"
    t.index ["video_id"], name: "index_userratings_on_video_id"
  end
  ...
  add_foreign_key "userratings", "videos"
